  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        neon: "bg-gradient-accent text-accent-foreground hover:shadow-glow-accent border border-accent/30 animate-pulse-glow",
        cyber: "bg-gradient-secondary text-secondary-foreground hover:shadow-secondary border border-secondary/50",
        matrix: "bg-gradient-card text-foreground border border-primary/30 hover:border-primary/50 hover:glow-primary backdrop-blur-sm",
      },
      size: {
